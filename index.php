...
<div class="col-md-12" style="text-align:center">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/i7.jpg" alt="Hero Slide" style="width:120%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/i8.jpg" alt="..." style="width:120%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/i9.jpg" alt="..." style="width:120%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/i11.jpg" alt="..." style="width:120%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/i12.jpg" alt="..." style="width:120%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/i13.jpg" alt="..." style="width:120%;height:500px;">
              ...
              <div class="form-group">
                  <input class="form-control" placeholder="Firstname" name="user_firstname" type="text" value="<?php  echo $user_firstname; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Empresa , Grupo,familia,Identificador,Etc" name="user_address" type="text" value="<?php  echo $user_address; ?>" required>
