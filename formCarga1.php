...
$fecha=$currentDate;
$ronda="Primera Ronda, Carga de Resultados Reales";
    ...
    $(document).ready(function() {
        ...
        $("#submit").click(function() {
         document.getElementById("elemento").style.display = "block";
            alertify.message('Procesando Datos');
           $("#mensaje").html('&nbsp');
           var formData = $("#form1").serialize();
           ...
           $.ajax({
               ...
               success: function(response) {
                   document.getElementById("elemento").style.display = "none";
                    alertify.success('Completado con Exito');
                   $("#mensaje").html('<b>Completado con exito</b>');
...
<div style="float: left">
          <img style="width: 180px; padding: 20px" onclick="location.replace('/main/index')" src="<?=$lae ?>">
    </div>
  <br>
           <br>
  ...
  <span style="text-height: 30px">Fecha actual: <b><?= $fecha ?></b></span> 
    <form name="form1" id="form1">
        <table align="center" border="0" style="text-align: center; width: 650px">
            <?php
            ...
            <div style="color:white;background-color:#008CBA" class="modal-content">
              ...
              <div class="form-group">
                  <input class="form-control" placeholder="Firstname" name="user_firstname" type="text" value="<?php  echo $user_firstname; ?>" required>
							...
							<p>Grupo,Empresa,Identificacion, Etc:</p>
                            <div class="form-group">
