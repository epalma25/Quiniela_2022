...
$fecha=$currentDate;
$ronda="Primera Ronda, Resultados Diarios";
...
<div style="float: left">
 ...
 <!-- <span style="text-height: 30px">Fecha actual: <?= $fecha ?></span> -->
         <br>
             <div class="nav-link js-scroll-trigger">
                                <button class="btn-success" onclick="alertify.YoutubeDialog('5X6YLoyak2I').set({frameless:true});">FINALES DE LOS MUNDIALES (1998-2018)™  Online</button>
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!isInTime($fecha)) { ?>
                            ...
                            <input type="number" min="0" max="15" name="<?= $idp . "_m1" ?>" value="<?= $marcador1 ?>" disabled="" style="width: 35px; text-align: center">
                  
                        <?php } else { ?>
                           <span class="cell-disable"><?= $marcador1 ?></span>  <?php } ?>
                    </td>
                    <td><b>Vs</b></td>
                    <td>
                        <?php if (!isInTime($fecha)) { ?>
                           
                            <input type="number" min="0" max="15" name="<?= $idp . "_m2" ?>" value="<?= $marcador2 ?>"  disabled="" style="width: 35px; text-align: center">
